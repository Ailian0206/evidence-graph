...
| ---: | --- | --- | --- |
| 1 | `feat/foundation-portfolio` | Next.js, bilingual portfolio, design system, tests, CI | Public pages run locally; complete static gate and visual QA |
...
Execute `docs/superpowers/plans/2026-07-15-foundation-portfolio-plan.md`.
